jQuery
		...
		createUploadForm : function(id, fileElementId, data) {
			...
			// var oldElement = jQuery('.himage');
			// var oldElement = jQuery("input[name='himage']");
			// var oldElement
			// =$("#cke_77_fileInput").contents().find("input[name='himage']");

			// var oldElement
			// =$($('.cke_dialog_ui_input_file').prop('contentWindow').document).find("input[name='himage']");
