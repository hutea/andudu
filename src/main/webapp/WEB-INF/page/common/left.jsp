...
<div class="leftpanel">
                    ...
                    <ul class="nav nav-pills nav-stacked">
                        ...
                        <li <c:if test="${param.m==1||m==1}">class="active parent"</c:if>  class="parent" ><a href=""><i class="fa fa-bars"></i> <span>订单管理</span></a>
                            <ul class="children">
                        ...
                        <li <c:if test="${param.m==3||m==3}">class="active parent"</c:if> class="parent" ><a href=""><i class="fa fa-suitcase"></i> <span>人员管理</span></a>
                            <ul class="children">
